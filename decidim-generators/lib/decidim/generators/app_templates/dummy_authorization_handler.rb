  ...
  class DummyActionAuthorizer < Decidim::Verifications::DefaultActionAuthorizer
    ...
    def authorize
      ...
      if allowed_postal_codes.present?
        ...
        status_code = :unauthorized if status_code == :ok && !allowed_postal_codes.member?(authorization.metadata["postal_code"])
      ...
      if allowed_scope.present?
        ...
        status_code = :unauthorized if status_code == :ok && allowed_scope_id != user_scope_id
